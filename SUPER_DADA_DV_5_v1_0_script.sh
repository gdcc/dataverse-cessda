...
find /usr/local/payara5/glassfish/domains/domain1/files/ -name "export_ddi.cached" -mtime -0.5 | sed 's/\/export_ddi.cached//g' > $filepath
...
doi=$(pwd | sudo sed 's/\/usr\|\/local\|\/payara5\|\/glassfish\|\/domains\|\/domain1\|\/files//g')
